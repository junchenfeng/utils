var FindProxyForURL = function(init, profiles) {
    ...
    "+auto switch": function(url, host, scheme) {
        ...
        if (/^10\.200\.41\.117$/.test(host)) return "DIRECT";
        if (/(?:^|\.)teambition\.com$/.test(host)) return "DIRECT";
        if (/(?:^|\.)teambition\.net$/.test(host)) return "DIRECT";
        if (/(?:^|\.)baidu\.com$/.test(host)) return "DIRECT";
        if (/(?:^|\.)1password\.com$/.test(host)) return "DIRECT";
        if (/(?:^|\.)17zuoye\.net$/.test(host)) return "DIRECT";
        if (/(?:^|\.)oaloft\.com$/.test(host)) return "DIRECT";
        if (/^10\.0\.2\.23$/.test(host)) return "DIRECT";
        if (/(?:^|\.)17test\.net$/.test(host)) return "DIRECT";
        if (/(?:^|\.)17zuoye\.com$/.test(host)) return "DIRECT";
        return "+__ruleListOf_auto switch";
    },
    "+__ruleListOf_auto switch": function(url, host, scheme) {
        "use strict";
        if (/^https:\/\/share\.dmhy\.org/.test(url)) return "+proxy";
        ...
        if (/^http:\/\/v2ex\.com/.test(url)) return "+proxy";
        if (/^http:\/\/cdn\.v2ex\.com/.test(url)) return "+proxy";
        if (/^http:\/\/cn\.v2ex\.com/.test(url)) return "+proxy";
        if (/^http:\/\/hk\.v2ex\.com/.test(url)) return "+proxy";
        if (/^http:\/\/i\.v2ex\.com/.test(url)) return "+proxy";
        if (/^http:\/\/lax\.v2ex\.com/.test(url)) return "+proxy";
        if (/^http:\/\/neue\.v2ex\.com/.test(url)) return "+proxy";
        if (/^http:\/\/pagespeed\.v2ex\.com/.test(url)) return "+proxy";
        if (/^http:\/\/static\.v2ex\.com/.test(url)) return "+proxy";
        if (/^http:\/\/workspace\.v2ex\.com/.test(url)) return "+proxy";
        if (/^http:\/\/www\.v2ex\.com/.test(url)) return "+proxy";
        ...
        if (/^https:\/\/www\.lightnovel\.cn/.test(url)) return "+proxy";
        ...
        if (/(?:^|\.)kh\.google\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)khm\.google\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)khm0\.google\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)khm1\.google\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)khm2\.google\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)khm3\.google\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)khmdb\.google\.com$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)khm\.googleapis\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)khm0\.googleapis\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)khm1\.googleapis\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)khm2\.googleapis\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)khm3\.googleapis\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)khmdb\.googleapis\.com$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)connectivitycheck\.gstatic\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)csi\.gstatic\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)fonts\.gstatic\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)ssl\.gstatic\.com$/.test(host)) return "+proxy";
    ...
    "+proxy": function(url, host, scheme) {
        ...
        return "SOCKS5 192.168.100.222:1080; SOCKS 192.168.100.222:1080";
    }
});